...
{
    public partial class UserControlQuickLaunch : UserControl
    {
        public UserControlQuickLaunch()
        {
            InitializeComponent();
        }
        public void ReturnFromCustomization()
        {
            ...
            {
                MessageBox.Show("QL:1" + ex.Message, "Openmiracle", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
            }
        }
        ...
        private void btnCustomizeMenu_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (open == null)
                {
                    ...
                    objMenuCustomization.MdiParent = Form.ActiveForm;
            ...
            {
                MessageBox.Show("QL:3" + ex.Message, "Openmiracle", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
            }
        }
