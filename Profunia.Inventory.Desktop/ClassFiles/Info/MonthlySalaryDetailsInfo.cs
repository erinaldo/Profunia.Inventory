...
{
	internal class MonthlySalaryDetailsInfo
	{
		...
		public decimal MonthlySalaryDetailsId
		{
			get
			{
				return _monthlySalaryDetailsId;
			}
			set
			{
				_monthlySalaryDetailsId = value;
			}
		}
		...
		public decimal SalaryPackageId
		{
			get
			{
				return _salaryPackageId;
			}
			set
			{
				_salaryPackageId = value;
			}
		}
