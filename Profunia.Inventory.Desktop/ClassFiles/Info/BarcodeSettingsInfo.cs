...
{
	internal class BarcodeSettingsInfo
	{
		...
		public decimal BarcodeSettingsId
		{
			get
			{
				return _barcodeSettingsId;
			}
			set
			{
				_barcodeSettingsId = value;
			}
		}
		...
		public bool ShowPurchaseRate
		{
			get
			{
				return _showPurchaseRate;
			}
			set
			{
				_showPurchaseRate = value;
			}
		}
