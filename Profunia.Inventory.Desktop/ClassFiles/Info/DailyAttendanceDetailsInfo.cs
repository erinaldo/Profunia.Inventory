...
{
	internal class DailyAttendanceDetailsInfo
	{
		...
		public decimal DailyAttendanceDetailsId
		{
			get
			{
				return _dailyAttendanceDetailsId;
			}
			set
			{
				_dailyAttendanceDetailsId = value;
			}
		}
		...
		public decimal DailyAttendanceMasterId
		{
			get
			{
				return _dailyAttendanceMasterId;
			}
			set
			{
				_dailyAttendanceMasterId = value;
			}
		}
