...
{
	internal class StockJournalDetailsInfo
	{
		...
		public decimal StockJournalDetailsId
		{
			get
			{
				return _stockJournalDetailsId;
			}
			set
			{
				_stockJournalDetailsId = value;
			}
		}
		...
		public decimal StockJournalMasterId
		{
			get
			{
				return _stockJournalMasterId;
			}
			set
			{
				_stockJournalMasterId = value;
			}
		}
		...
		public string ConsumptionOrProduction
		{
			get
			{
				return _consumptionOrProduction;
			}
			set
			{
				_consumptionOrProduction = value;
			}
		}
