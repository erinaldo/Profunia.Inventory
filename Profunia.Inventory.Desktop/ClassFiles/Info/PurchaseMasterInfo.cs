...
namespace Profunia.Inventory.Desktop.ClassFiles.Info
{
	internal class PurchaseMasterInfo
	{
		...
		public decimal PurchaseMasterId
		{
			get
			{
				return _purchaseMasterId;
			}
			set
			{
				_purchaseMasterId = value;
			}
		}
		...
		public decimal PurchaseOrderMasterId
		{
			get
			{
				return _purchaseOrderMasterId;
			}
			set
			{
				_purchaseOrderMasterId = value;
			}
		}
		...
		public decimal MaterialReceiptMasterId
		{
			get
			{
				return _materialReceiptMasterId;
			}
			set
			{
				_materialReceiptMasterId = value;
			}
		}
