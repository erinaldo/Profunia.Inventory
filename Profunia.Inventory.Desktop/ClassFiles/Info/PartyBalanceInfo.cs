...
{
	internal class PartyBalanceInfo
	{
		...
		public decimal PartyBalanceId
		{
			get
			{
				return _partyBalanceId;
			}
			set
			{
				_partyBalanceId = value;
			}
		}
		...
		public decimal AgainstVoucherTypeId
		{
			get
			{
				return _againstVoucherTypeId;
			}
			set
			{
				_againstVoucherTypeId = value;
			}
		}
		...
		public string AgainstVoucherNo
		{
			get
			{
				return _againstVoucherNo;
			}
			set
			{
				_againstVoucherNo = value;
			}
		}
		...
		public string AgainstInvoiceNo
		{
			get
			{
				return _againstInvoiceNo;
			}
			set
			{
				_againstInvoiceNo = value;
			}
		}
