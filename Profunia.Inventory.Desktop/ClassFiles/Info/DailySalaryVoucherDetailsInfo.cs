...
{
	internal class DailySalaryVoucherDetailsInfo
	{
		...
		public decimal DailySalaryVoucherDetailsId
		{
			get
			{
				return _dailySalaryVoucherDetailsId;
			}
			set
			{
				_dailySalaryVoucherDetailsId = value;
			}
		}
		...
		public decimal DailySalaryVocherMasterId
		{
			get
			{
				return _dailySalaryVoucherMasterId;
			}
			set
			{
				_dailySalaryVoucherMasterId = value;
			}
		}
