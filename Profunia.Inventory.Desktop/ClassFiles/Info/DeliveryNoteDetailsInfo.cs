...
{
	internal class DeliveryNoteDetailsInfo
	{
		...
		public decimal DeliveryNoteDetails1Id
		{
			get
			{
				return _deliveryNoteDetails1Id;
			}
			set
			{
				_deliveryNoteDetails1Id = value;
			}
		}
		...
		public decimal DeliveryNoteMasterId
		{
			get
			{
				return _deliveryNoteMasterId;
			}
			set
			{
				_deliveryNoteMasterId = value;
			}
		}
		...
		public decimal OrderDetails1Id
		{
			get
			{
				return _orderDetails1Id;
			}
			set
			{
				_orderDetails1Id = value;
			}
		}
		...
		public decimal QuotationDetails1Id
		{
			get
			{
				return _quotationDetails1Id;
			}
			set
			{
				_quotationDetails1Id = value;
			}
		}
