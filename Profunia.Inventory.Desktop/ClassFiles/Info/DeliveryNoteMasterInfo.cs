...
{
	internal class DeliveryNoteMasterInfo
	{
		...
		public decimal OrderMasterId
		{
			get
			{
				return _orderMasterId;
			}
			set
			{
				_orderMasterId = value;
			}
		}
		...
		public decimal QuotationMasterId
		{
			get
			{
				return _quotationMasterId;
			}
			set
			{
				_quotationMasterId = value;
			}
		}
