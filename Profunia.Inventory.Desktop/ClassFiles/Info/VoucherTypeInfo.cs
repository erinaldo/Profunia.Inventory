...
{
	internal class VoucherTypeInfo
	{
		...
		public string TypeOfVoucher
		{
			get
			{
				return _typeOfVoucher;
			}
			set
			{
				_typeOfVoucher = value;
			}
		}
		...
		public string MethodOfVoucherNumbering
		{
			get
			{
				return _methodOfVoucherNumbering;
			}
			set
			{
				_methodOfVoucherNumbering = value;
			}
		}
