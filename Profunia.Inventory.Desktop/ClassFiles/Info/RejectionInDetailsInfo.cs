...
{
	internal class RejectionInDetailsInfo
	{
		...
		public decimal RejectionInDetailsId
		{
			get
			{
				return _rejectionInDetailsId;
			}
			set
			{
				_rejectionInDetailsId = value;
			}
		}
		...
		public decimal RejectionInMasterId
		{
			get
			{
				return _rejectionInMasterId;
			}
			set
			{
				_rejectionInMasterId = value;
			}
		}
		...
		public decimal DeliveryNoteDetailsId
		{
			get
			{
				return _deliveryNoteDetailsId;
			}
			set
			{
				_deliveryNoteDetailsId = value;
			}
		}
