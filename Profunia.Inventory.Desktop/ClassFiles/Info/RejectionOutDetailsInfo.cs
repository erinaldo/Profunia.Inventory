...
{
	internal class RejectionOutDetailsInfo
	{
		...
		public decimal RejectionOutDetailsId
		{
			get
			{
				return _rejectionOutDetailsId;
			}
			set
			{
				_rejectionOutDetailsId = value;
			}
		}
		...
		public decimal RejectionOutMasterId
		{
			get
			{
				return _rejectionOutMasterId;
			}
			set
			{
				_rejectionOutMasterId = value;
			}
		}
		...
		public decimal MaterialReceiptDetailsId
		{
			get
			{
				return _materialReceiptDetailsId;
			}
			set
			{
				_materialReceiptDetailsId = value;
			}
		}
