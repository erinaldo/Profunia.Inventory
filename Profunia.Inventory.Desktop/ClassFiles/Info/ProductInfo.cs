...
namespace Profunia.Inventory.Desktop.ClassFiles.Info
{
	internal class ProductInfo
	{
		...
		public bool Ismultipleunit
		{
			get
			{
				return _ismultipleunit;
			}
			set
			{
				_ismultipleunit = value;
			}
		}
		...
		public bool Isopeningstock
		{
			get
			{
				return _isopeningstock;
			}
			set
			{
				_isopeningstock = value;
			}
		}
		...
		public bool IsshowRemember
		{
			get
			{
				return _isshowRemember;
			}
			set
			{
				_isshowRemember = value;
			}
		}
