...
{
	internal class SalaryVoucherDetailsInfo
	{
		...
		public decimal SalaryVoucherDetailsId
		{
			get
			{
				return _salaryVoucherDetailsId;
			}
			set
			{
				_salaryVoucherDetailsId = value;
			}
		}
		...
		public decimal SalaryVoucherMasterId
		{
			get
			{
				return _salaryVoucherMasterId;
			}
			set
			{
				_salaryVoucherMasterId = value;
			}
		}
